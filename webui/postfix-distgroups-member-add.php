...
if ($_POST['action'] == "add")  {
?>
	<h1>Add Distribution Group Member</h1>
<?php
?>
...
?>
	<h1>Distribution Group Member Add Results</h1>

<?php

	$stmt = $db->prepare("INSERT INTO distribution_group_members (DistributionGroupID,Goto,Disabled) VALUES (?,?,1)");
